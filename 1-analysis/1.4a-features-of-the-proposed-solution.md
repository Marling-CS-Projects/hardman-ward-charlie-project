...
<figure><img src="../.gitbook/assets/image (2) (1) (1) (1) (2) (1).png" alt=""><figcaption><p>In this Flappy Bird game, the player's character is always on the left side of the screen</p></figcaption></figure>
...
The Zombie will be the weakest enemy in the game. It walks slowly towards the player when they come into its range, and can easily be outrun. It will have five hearts. The zombie inflicts damage on the player by colliding with them, and will deal one heart of damage per hit multiplied by the level number.

### Skeleton (based on Minecraft Skeleton)

<figure><img src="../.gitbook/assets/New Piskel (2).png" alt=""><figcaption></figcaption></figure>

The skeleton will attempt to attack any player that comes within range of it by firing arrows. The arrows knock the player back and deal up to one heart of damage per hit multiplied by the level number. Like the zombie, the skeleton has five hearts.
...
The Exploding Terror will sprint up towards the player and then detonate. The explosion takes three hearts multiplied by the level, subtract the number of full tiles (1 tile = 32 pixels) separating between the player and the Exploding Terror on detonation.&#x20;
