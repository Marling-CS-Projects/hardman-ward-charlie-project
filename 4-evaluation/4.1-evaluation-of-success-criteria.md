...
The purpose of criterion 15 is to provide a screen that allows the player to join an existing room by entering an eight character code or create a new room. The scene and all its functions work as intended. In Usability Testing, all respondents agreed the game was at least mostly clear about options for multiplayer, with over half saying it was very clear.
