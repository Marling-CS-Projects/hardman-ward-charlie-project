...
| Test | Instructions                                                                | What I expect                                                            | Pass/Fail |
| ---- | --------------------------------------------------------------------------- | ------------------------------------------------------------------------ | --------- |
| 1    | If blindness is activated, give all other players blindness for 10 seconds. | Other players get blindness for 10 seconds when the player activates it. | Pass      |
