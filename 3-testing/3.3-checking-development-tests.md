...
<figure><img src="../.gitbook/assets/image (2).png" alt=""><figcaption><p>Test 1: users table</p></figcaption></figure>

<figure><img src="../.gitbook/assets/image (1) (1).png" alt=""><figcaption><p>Test 1: sessions table</p></figcaption></figure>
...
<figure><img src="../.gitbook/assets/image (2) (1).png" alt=""><figcaption><p>Test 1: Entry with username and hashed password written to users table</p></figcaption></figure>
...
<figure><img src="../.gitbook/assets/image.png" alt=""><figcaption><p>Test 1: Position indicator displayed in bottom left</p></figcaption></figure>
...
<figure><img src="../.gitbook/assets/image (1).png" alt=""><figcaption><p>Test 1: Hearts rendered at top left of screen representing health points</p></figcaption></figure>
...
| 2    | Zombie walk toward target and hit them.                           | Zombies in the Army walk towards the close by player and hit them, dealing 1 point of damage.                                 | Pass      |
| 3    | Skeleton get relatively close to target and shoot arrows at them. | Skeletons in the Army get within range of the close by player and shoot arrows at them, any that hit deal 2 points of damage. | Pass      |
| 4    | Creeper run up to player and explode on collision.                | The Creeper in the Army runs up to the player and explodes on touching them, dealing 4 points of damage.                      | Pass      |
| 5    | Destroy monsters after 30 seconds.                                | The Army disappears after 30 seconds.                                                                                         | Pass      |
