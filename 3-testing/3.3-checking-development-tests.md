...
| 2    | Decide power-up by checking factors and display to player.        | Power-up appears in container on left of screen after the  player collides with a chest. | Pass      |
