...
| Test | Instructions                                                     | What I expect                                                                           | Pass/Fail |
| ---- | ---------------------------------------------------------------- | --------------------------------------------------------------------------------------- | --------- |
| 1    | Display final leaderboard after completing all four levels.      | Final leaderboard displayed after completing all four levels with the overall rankings. | Pass      |
| 2    | When the player clicks the title button, go back to title scene. | Game goes back to title screen when the player clicks the button.                       | Pass      |
