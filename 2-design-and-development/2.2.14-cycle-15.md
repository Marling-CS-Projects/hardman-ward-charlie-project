...
Firstly, I added to the handleCollisions function that I setup in [Cycle 12](2.2.12-cycle-12.md) to detect collisions between the player's car and any chest. If this happens, the game sends an event to the server to delete the chest from the world and broadcast an updated world to all players in the room.
