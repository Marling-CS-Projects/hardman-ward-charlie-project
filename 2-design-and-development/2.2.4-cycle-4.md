...
* [x] Get session value from browser cookie.
* [x] Submit POST request to server containing session.
* [x] Get username corresponding to session using SQL query in sessions table.
* [x] If entry found, send username value back to client. Otherwise, send 404 (not found) error back to client.
* [x] If POST request successful, output username to browser console.
* [x] If POST request resulted in error, output message saying user isn't signed in.
