...
Upon detection of a touchscreen, my game will render five buttons on the left side of the screen for movement and jumping. This is how Minecraft implemented touchscreen support on smartphones and tablets.
...
<figure><img src="../.gitbook/assets/multiplayer2 (2).png" alt=""><figcaption></figcaption></figure>
...
Keyboard players can navigate the hotbar using the number keys on the keyboard. Upon detection of a touchscreen, two arrows will be rendered to the right of the hotbar that allow the player to change their selection.

<figure><img src="../.gitbook/assets/hotbartouch.png" alt=""><figcaption><p>Planned hotbar layout on touch devices</p></figcaption></figure>
