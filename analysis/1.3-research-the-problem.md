...
| ----------------------------- | ------------------------------------------------------------------------------------------ |
| Zombie, skeleton, and creeper | These will be the most common enemies in the game — killing them can restore health points |
...
A side-scroller is a type of video game where the camera moves in accordance to how the player is moving, so that the player sprite is always visible in a certain position on the screen [(Rouse, 2011)](https://www.techopedia.com/definition/27153/side-scroller).&#x20;
...
| Feature                       | Justification                                                                                                                 |
| ----------------------------- | ----------------------------------------------------------------------------------------------------------------------------- |
| Undead Miner                  | The Undead Miner will be more suited for cave environments and will provide a challenge for the player                        |
...
| Background blocks             | Darker blocks for background of areas such as caves will make the game look more realistic than the sky being the background. |
|                               |                                                                                                                               |
{% endtab %}
